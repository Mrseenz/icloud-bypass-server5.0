...
openssl x509 -req -in iPhoneCA.csr -CA RootCA.crt -CAkey RootCA_private.key -out iPhoneCA.crt -days 3653 -sha256 -extfile extensions_iphone_ca.cnf -extensions v3_req  -set_serial 0x17 -passin pass:icloud
REM --------
...
openssl x509 -req -in iPhoneDeviceCA.csr -CA iPhoneCA.crt -CAkey iPhoneCA_private.key -out iPhoneDeviceCA.crt -days 3653 -sha256 -extfile extensions_device_ca.cnf -extensions v3_req  -set_serial 0x01 -passin pass:icloud
REM --------
...
openssl x509 -req -in iPhoneActivation.csr -CA iPhoneCA.crt -CAkey iPhoneCA_private.key -out iPhoneActivation.crt -days 3653 -sha256 -extfile extensions_activation.cnf -extensions v3_req  -set_serial 0x02 -passin pass:icloud
REM --------
REM Device
