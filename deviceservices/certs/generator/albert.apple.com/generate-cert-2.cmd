...
openssl x509 -req -in VeriSignClass.csr -CA VeriSign.crt -CAkey VeriSign_private.key -out VeriSignClass.crt -days 3653 -sha256 -extfile cert_2.cnf -extensions v3_req -passin pass:icloud
