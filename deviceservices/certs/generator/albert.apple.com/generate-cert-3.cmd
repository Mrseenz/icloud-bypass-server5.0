...
openssl x509 -req -in albert.csr -CA VeriSignClass.crt -CAkey VeriSignClass_private.key -out albert.crt -nameopt RFC2253 -days 3653 -sha256 -extfile cert_3.cnf -extensions v3_req -passin pass:icloud
