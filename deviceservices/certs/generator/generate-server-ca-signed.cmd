...
openssl x509 -req -sha256 -in cert-request.csr -CA iPhoneDeviceCA.crt -CAkey iPhoneDeviceCA_private.key -out serverCASigned.crt -days 3653 -extfile extensions_device.cnf -extensions usr_cert -CAserial cert-sn.srl -passin pass:icloud
pause
REM --------
REM 
