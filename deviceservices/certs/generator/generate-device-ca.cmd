...
openssl req -new -x509 -sha256 -keyout iPhoneDeviceCA_private.key -out iPhoneDeviceCA.crt -days 3653 -set_serial 0x01 -config extensions_device_ca.cnf -reqexts v3_req -extensions v3_req -passout pass:icloud
